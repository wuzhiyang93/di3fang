 ...
 * @param query 查询参数
 */
export function queryMarketingCatesByTypeForPresale() {
  return request({
    url: 'depositpresale/cates',
    method: 'get',
  })
}
 ...
 *  查询定金预售促销分类（修改定金预售用）
 */
export function queryMarketingCatesByTypeForPresaleUpdate() {
  return request({
    url: 'depositpresale/update/cates',
    method: 'get',
  })
}
