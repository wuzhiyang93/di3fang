    ...
    <div id="print_box">
      ...
      <div class="detailsTable">
        ...
        <el-row>
          ...
          <el-col :span="8">优惠卷金额：{{order.couponPrice == 0?order.couponPrice.toFixed(2):order.couponPrice.toFixed(2)+'('
            + order.couponNo + ')'}}
          </el-col>
        </el-row>
        <el-row>
      ...
      <div class="detailsTable">
        <el-row>
          <el-col :span="8">配送方式：{{order.orderAttr.deliveryType == 1 ? '团长送货上门' : '用户自提'}}
          </el-col>
          <el-col :span="8">团长手机号：{{order.communityBuyHeadMobile}}</el-col>
          <el-col :span="8">提货人手机号：{{order.customerMobile}}</el-col>
        </el-row>
        <el-row>
          <el-col :span="8">收货地址：{{order.orderAttr.address}}</el-col>
          <el-col :span="8">详细地址：{{order.orderAttr.detailAddress}}</el-col>
        </el-row>
      </div>
