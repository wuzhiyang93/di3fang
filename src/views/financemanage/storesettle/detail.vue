<template>
  <div class="dashboard-editor-container">
    <div>
      <p class="flex"><span>商户名称：{{Item.storeName}}</span><span>结算金额：{{Item.settleAmount}}</span></p>
    ...
    width="40%"
    >
      <template v-if="Item.remitPic"><img style="width:100%" :src="Item.remitPic"></template>
