<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <br/>
      <router-link to="/sitesetting/help/addhelp">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="150">
        <template slot-scope="scope">
          <router-link :to="{path:'/sitesetting/help/updatehelp',query:{id:scope.row.id}}">
...
<script>
  import {queryHelpList, deleteHelp} from '@/api/helplist';
