  ...
  <div class="app-container">
          ...
          <div class="el-tabs__nav-scroll">
            <div class="el-tabs__nav is-top">
              <router-link style="display: block; float: left" class="el-tabs__item is-top"
                           to="/statisticalreport/platformstatistics/membersordersstatistics">会员下单量
              </router-link>
              <div style="display: block; float: left" class="el-tabs__item is-top is-active">会员消费量</div>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <el-table-column label="消费额">
        <template slot-scope="scope">{{ scope.row.consumption | toFixed }}</template>
      </el-table-column>
    </el-table>
...
<script>
  ...
  import {
    queryCustomerConsumption  //分页查询用户消费额
  } from '@/api/membersexpenditurestatistics';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryCustomerConsumption(this.listQuery).then(response => {
