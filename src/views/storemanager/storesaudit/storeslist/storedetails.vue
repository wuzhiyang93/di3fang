      ...
      <el-row>
        ...
        <el-col :span="8">详细地址：
            <div style="display:inline-block;position: relative;width: 300px;top: 0px;">
              <el-select v-model="storeInfo.provinceId" disabled  placeholder="选择省份" style="width:30%;float:left">
              <el-option
            ...
            <el-select v-model="storeInfo.cityId"  disabled  placeholder="选择城市" style="width:30%;position: absolute;right:35%">
              <el-option
            ...
            <el-select v-model="storeInfo.districtId" disabled placeholder="选择区域" style="width:30%;position: absolute;right:0">
              <el-option
