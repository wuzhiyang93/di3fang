  ...
  <div class="app-container">
          ...
          <div class="el-tabs__nav-scroll">
            <div class="el-tabs__nav is-top">
              <router-link style="display: block; float: left" class="el-tabs__item is-top"
                           to="/statisticalreport/platformstatistics/storesordersstatistics">店铺销售量列表
              </router-link>
              <div style="display: block; float: left" class="el-tabs__item is-top is-active">店铺销售额列表</div>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <el-table-column label="销售额">
        <template slot-scope="scope">{{ scope.row.salesAmount | toFixed }}</template>
      </el-table-column>
    </el-table>
...
<script>
  import {
    queryStoreSaleAmout  //分页查询店铺销售额
  } from '@/api/storesexpenditurestatistics';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryStoreSaleAmout(this.listQuery).then(response => {
