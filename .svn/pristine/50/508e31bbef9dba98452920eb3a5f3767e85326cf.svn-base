<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <div class="filterBox">
        <p>订单号</p>
        <el-input v-model="listQuery.orderCode" maxlength="64" placeholder="订单号" size="medium" style="width: 150px;"
                  class="filter-item"/>
      </div>
      <div class="filterBox">
        <p>用户名</p>
        <el-input v-model="listQuery.customerName" maxlength="32" placeholder="用户名" size="medium" style="width: 150px;"
                  class="filter-item"/>
      </div>
      <div class="filterBox">
        <p>店铺名称</p>
        <el-input placeholder="店铺名称" v-model="listQuery.storeName" maxlength="32" size="medium" style="width: 150px;"
                  class="filter-item"/>
      </div>
      <div class="filterBox">
        <p>订单类型</p>
        <el-select class="filter-item" v-model="listQuery.orderType" size="medium" style="width: 150px"
          ...
          <el-option label="虚拟商品" value="7"></el-option>
        </el-select>
      </div>
      <el-date-picker
        style="width: 355px"
...
<script>
  ...
  import {queryStoreOrders, confirmOrder, changePrice, exportAllOrder, exportCheckedOrder} from '@/api/storeorderlist';
