  ...
  <div class="app-container">
    ...
    <el-form label-position="right" :model="form" :rules="rules" ref="form" label-width="150px"
      ...
      <el-form-item prop="senderEmail">
        ...
        <el-input v-model="form.senderEmail" maxlength="30"/>
      </el-form-item>
...
<script>
  import {queryEmailSet, updateEmailSet,} from '@/api/emailset'
