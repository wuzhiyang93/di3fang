        ...
        <div class="el-tabs__nav-wrap is-top">
          <div class="el-tabs__nav-scroll">
            <div class="el-tabs__nav is-top">
              <div style="display: block; float: left" class="el-tabs__item is-top is-active">单品销售量列表</div>
              <router-link style="display: block; float: left" class="el-tabs__item is-top"
                           to="/statisticalReport/platformStatistics/goodsExpenditureStatistics">单品销售额列表
              </router-link>
            </div>
          </div>
        </div>
...
<script>
  ...
  import {
    querySkuSaleVolume  //分页查询单品销量
  } from '@/api/goodsordersstatistics';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        querySkuSaleVolume(this.listQuery).then(response => {
