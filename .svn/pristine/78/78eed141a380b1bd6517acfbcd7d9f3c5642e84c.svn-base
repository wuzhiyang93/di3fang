 ...
 * 查询拼团促销的分类（新增拼团促销用）
 */
export function queryMarketingCatesByTypeForAddGroup() {
  return request({
    url: 'addgroupmarketing/cates',
    method: 'get',
  })
}
 ...
 * 查询拼团促销的分类（修改拼团促销用）
 */
export function queryMarketingCatesByTypeForUpdateGroup() {
  return request({
    url: 'updategroupmarketing/cates',
    method: 'get',
  })
}
 ...
 * 查询拼团促销的分类（查询拼团促销详情用）
 */
export function queryMarketingCatesByTypeForDetail() {
  return request({
    url: 'groupmarketingdetail/cates',
    method: 'get',
  })
}
