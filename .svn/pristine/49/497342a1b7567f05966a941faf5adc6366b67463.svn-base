    ...
    >
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <router-link
            :to="{path:'/applet/appletthematic/updateappletthematic',query:{initId:scope.row.id}}">
    ...
    <el-dialog title="选择模板" :visible.sync="dialogFormVisible" width="820px">
      <div v-for="i in templateList" class="template_box clearfix" style="width: 218px; box-sizing: initial; display: inline-block!important;">
        ...
        <div style="display: flex; justify-content: space-between; margin-top: 10px">
          ...
          <router-link
            :to="{path:'/applet/appletthematic/addappletthematic',query:{initId:i.value}}">
...
<script>
  ...
  import {
    queryAppletThematic,
    deleteAppletThematic
  } from '@/api/appletsthematics';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryAppletThematic(this.listQuery).then((response) => {
