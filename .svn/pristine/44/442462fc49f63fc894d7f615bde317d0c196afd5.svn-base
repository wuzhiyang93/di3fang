        ...
        <div class="el-tabs__nav-wrap is-top">
          <div class="el-tabs__nav-scroll">
            <div class="el-tabs__nav is-top">
              <div style="display: block; float: left" class="el-tabs__item is-top is-active">店铺销售量列表</div>
              <router-link style="display: block; float: left" class="el-tabs__item is-top"
                           to="/statisticalReport/platformStatistics/storesExpenditureStatistics">店铺销售额列表
              </router-link>
            </div>
          </div>
        </div>
...
<script>
  ...
  import {
    queryStoreSaleVolume  //分页查询店铺销量
  } from '@/api/storesordersstatistics';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryStoreSaleVolume(this.listQuery).then(response => {
