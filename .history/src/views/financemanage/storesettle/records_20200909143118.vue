<template>
  <div class="dashboard-editor-container">
    <el-form ref="storeForm" :model="storeForm" class="storeForm">
      <div class="flex">
          <el-input v-model="storeForm.supplierName"  placeholder="输入供应商名称"></el-input>
          <el-input v-model="storeForm.settleCode"  placeholder="输入结算单号"></el-input>
          <el-select v-model="storeForm.status" placeholder="是否打款">
            <el-option
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-tag v-if="scope.row.remitStatus == '1'" type="success">已结算</el-tag>
